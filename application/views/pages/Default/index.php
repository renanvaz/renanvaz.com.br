<main itemscope itemtype="http://schema.org/Person">
    <aside>
        ...
        <nav>
            ...
            <li>Cel: <a href="callto:71486994" itemprop="telephone">+55 (11) 7148.6994</a></li>
            <li>Skype: vazrenan</li>
            <li>Gtalk: <a href="mailto:renan.c.vaz@gmail.com" itemprop="email">renan.c.vaz@gmail.com</a></li>
            <li>Facebook: <a href="http://www.facebook.com/renanvaz">/renanvaz</a></li>
            <li>Twitter: <a href="http://www.twitter.com/renanvaz">@renanvaz</a></li>
            <li>Linkedin: <a href="http://br.linkedin.com/in/renanvaz">/in/renanvaz</a></li>

            <address itemprop="address"><i></i> Mogi das Cruzes, SP - Brazil</address>
        </nav>
    </aside>
    <article>
